...
namespace TransportSystem.Core.Application.Common.Interfaces
{
    public interface IAccountService
    {
        ...
        Task RestoreUserAsync(string userId, CancellationToken cancellationToken = default);
        ...
        Task<IReadOnlyList<UserResult>> GetAllAsync(bool archivedOnly = false, CancellationToken cancellationToken = default);
