...
{
    public class ExportReportsPdfQueryHandler : IRequestHandler<ExportReportsPdfQuery, byte[]>
    {
        ...
        public ExportReportsPdfQueryHandler(IVehicleRepository vehicleRepository, IDriverRepository driverRepository,
        ...
        public async Task<byte[]> Handle(ExportReportsPdfQuery request, CancellationToken cancellationToken)
        {
            ...
            return _exportService.GeneratePdf(summary);
        }
    }
}
